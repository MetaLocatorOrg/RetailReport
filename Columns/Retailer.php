 ...
 *
 */
namespace Piwik\Plugins\RetailReport\Columns;
...
class Retailer extends ConversionDimension
{
     ...
     * the value of the tracking url parameter "myCustomParam" in the "retailer_name" column.
     * Return boolean false if you do not want to change the value in some cases. If you do not want to perform any
     * action on an ecommerce order at all it is recommended to just remove this method.
     *
     * @param Request $request
     ...
     * goal in the 'retailer_name' column if the visitor is known and nothing otherwise.
     * Return boolean false if you do not want to change the value in some cases. If you do not want to perform any
     * action on an ecommerce order at all it is recommended to just remove this method.
     *
     * @param Request $request
