 ...
 */
class GetActionsbySKURetailer extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('RetailReport_ActionsbySKURetailer');
        $this->dimension     = null;
        ...
        // $this->menuTitle    = 'RetailReport_ActionsbySKURetailer';
        ...
        // $this->widgetTitle  = 'RetailReport_ActionsbySKURetailer';
    }
    ...
    {
        $view = new View('@RetailReport/getActionsbySKURetailer');
        $view->myData = array();
